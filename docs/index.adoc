...
[NOTE]
====
This guide assues you are already familiar with Gatsby, Enonic XP and the headless API in particular. If not, we recommed that looking into these tutorials before commencing:
